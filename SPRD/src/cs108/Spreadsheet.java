...
public final class Spreadsheet extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        for (Cell cell : cells) {
            ...
            cellButton.setFont(new Font(16));
            ...
            cell.addObserver(o -> cellButton.setText(String.valueOf(cell.getValue())));
        }
        ...
        formulaField.setPrefHeight(40);
        formulaField.setFont(new Font(15));

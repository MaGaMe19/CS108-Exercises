...
public class LZWTest {
    ...
    public Decoder newDecoder(SortedSet<Character> alphabet, int dictCapacity) {
        return new LZWDecoder(alphabet, dictCapacity);
    }
    ...
    public void encoderCorrectlyEncodesEmptyString() {
        Encoder e = newEncoder(Collections.emptySortedSet(), 10);
    ...
    public void decoderCorrectlyDecodesExample() {
        SortedSet<Character> alphabet = new TreeSet<>(Set.of('a', 'b', 'e', 'n'));
        Decoder d = newDecoder(alphabet, 8);
    ...
    public void decoderCorrectlyHandlesTrickyCase() {
        ...
        Decoder d = newDecoder(alphabet, 2);
    ...
    public void repeatedSequenceIsCorrectlyEncodedAndDecoded() {
        ...
        Encoder e = newEncoder(alphabet, dictCapacity);
        Decoder d = newDecoder(alphabet, dictCapacity);
